...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
	<div class="font-[sans-serif] bg-gradient-to-r from-purple-900 via-purple-800 to-purple-600 text-[#333]">
      <div class="min-h-screen flex fle-col items-center justify-center lg:p-6 p-4">
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div class="max-md:text-center">
            <a href="javascript:void(0)"><img
              src="https://readymadeui.com/readymadeui-white.svg" alt="logo" class='w-52 mb-10 inline-block' />
            </a>
            ...
            <p class="text-sm mt-10 text-white">Don't have an account <a href="javascript:void(0);" class="text-white font-semibold underline ml-1">Register here</a></p>
          </div>
