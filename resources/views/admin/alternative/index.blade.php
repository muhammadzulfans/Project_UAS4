...
@section('contents')
    <div class="hero"
        ...
        <div class="hero-content text-center text-white py-5">
            <h1 class="display-4" style="color: black; font-weight: bold;">Sistem Pendukung Keputusan Perusahaan Tour & Travel</h1>
                        ...
                        <tr x-data="{ showModal: false }">
                            ...
                            <td class="align-middle">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a href="{{ route('alternative.edit', $item->id) }}" type="button"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showModal" x-cloak
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-4">
                    <form action="{{ route('alternative.destroy', $item->id) }}" method="POST" class="inline-block">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
