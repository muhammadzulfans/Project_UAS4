        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="{{ route('kriteria.update', $kriteria->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="kode_kriteria" id="kode_kriteria" value="{{ $kriteria->kode_kriteria }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>

                <div class="mb-4">
                    <label for="nama_kriteria" class="block text-gray-700 font-bold mb-2">Nama Kriteria:</label>
                    <input type="text" name="nama_kriteria" id="nama_kriteria" value="{{ $kriteria->nama_kriteria }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>

                <div class="mb-4">
                    <label for="bobot_kriteria" class="block text-gray-700 font-bold mb-2">Bobot Kriteria:</label>
                    <input type="number" step="any" name="bobot_kriteria" id="bobot_kriteria" value="{{ $kriteria->bobot_kriteria }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
